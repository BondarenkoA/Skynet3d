...
#define Z_SERVO_ANGLES {10,90}//#define Z_SERVO_ANGLES {70,0} // Z Servo Deploy and Stow angles
...
#define Z_PROBE_SPEED_SLOW 240//(Z_PROBE_SPEED_FAST / 2)
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT X_MAX_POS - 38 //(X_MAX_POS / 2)    // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT 29 //(Y_MAX_POS / 2)    // Y point for Z homing when homing all axis (G28).
#endif
